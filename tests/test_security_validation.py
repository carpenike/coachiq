...
class TestInputValidation:
    ...
    def test_validate_ip_address(self):
        ...
        # Use a real public IPv6 (Google DNS); 2001:db8::/32 is RFC 3849
        # documentation prefix and is correctly classified as private/reserved.
        ...
        with pytest.raises(ValidationError):
            validate_ip_address("2001:db8::1")  # RFC 3849 documentation prefix
