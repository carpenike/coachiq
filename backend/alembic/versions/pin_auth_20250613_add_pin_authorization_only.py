...
down_revision: Union[str, None] = 'notification_analytics_001'
...
def upgrade() -> None:
    ...
    op.create_table('pin_sessions',
        ...
        sa.ForeignKeyConstraint(['user_pin_id'], ['user_pins.id'], ),
        sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_pin_sessions_created_by_user_id'), 'pin_sessions', ['created_by_user_id'], unique=False)
    op.create_index(op.f('ix_pin_sessions_session_id'), 'pin_sessions', ['session_id'], unique=True)
    op.create_index(op.f('ix_pin_sessions_user_pin_id'), 'pin_sessions', ['user_pin_id'], unique=False)
    ...
    op.create_index(op.f('ix_pin_attempts_attempted_at'), 'pin_attempts', ['attempted_at'], unique=False)
    op.create_index(op.f('ix_pin_attempts_attempted_by_user_id'), 'pin_attempts', ['attempted_by_user_id'], unique=False)
    ...
    op.create_index(op.f('ix_pin_attempts_user_pin_id'), 'pin_attempts', ['user_pin_id'], unique=False)
