...
def get_database_url() -> str:
    """Get database URL from our DatabaseEngine configuration."""
...
def run_migrations_offline() -> None:
    ...
    # Skip migrations for null backend (no persistence mode)
    if url == "null://memory":
        print("Persistence disabled - skipping database migrations")
        return
...
async def run_async_migrations() -> None:
    ...
    # Get database settings and create async engine
    db_settings = DatabaseSettings()
    db_url = db_settings.get_database_url()

    # Skip migrations for null backend (no persistence mode)
    if db_url == "null://memory":
        print("Persistence disabled - skipping database migrations")
        return
